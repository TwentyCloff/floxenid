  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-n-8 p-4">
      <div className="bg-n-7 p-8 rounded-[2rem] max-w-lg w-full shadow-2xl">
        <h2 className="text-3xl font-bold text-center text-white mb-6">Payment Gateway</h2>
        ...
        {selectedMethod === "card" ? (
          <form className="space-y-4">
            <div>
              <label className="block text-sm text-white mb-1">Card Number</label>
              <input
                type="text"
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <label className="block text-sm text-white mb-1">CVV</label>
                <input
                  type="text"
                  placeholder="123"
                  className="w-full px-4 py-3 bg-n-6 border border-n-5 rounded-lg text-white placeholder:text-n-4"
          ...
          <div className="flex flex-col items-center text-center space-y-5 mt-6">
            <p className="text-white text-sm">
              Scan this QR code with your <strong>{selectedMethod.toUpperCase()}</strong> app to pay.
            </p>
