...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* Wrapper kecil untuk background dan video yang hanya bungkus Empower */}
      <div className="relative overflow-hidden z-0">
        {/* Background hitam */}
        <div className="absolute inset-0 bg-[#0a0a0a] z-[-20] pointer-events-none" />

        {/* Video blackhole dengan filter brightness */}
        <video
          autoPlay
          muted
          loop
      ...
      {/* CompanyLogos dan BottomLine di luar wrapper video, tanpa efek filter */}
