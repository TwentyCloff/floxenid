...
const PricingList = () => {
  ...
  const features = [
    ...
    {
      name: "Meridian Unlock",
      originQi: false,
      halfSaint: true,
      peakImmortal: true
    },
    {
      name: "Spiritual Sense Training",
      originQi: false,
      halfSaint: true,
      peakImmortal: true
    },
    {
      name: "Divine Beast Companion",
      originQi: false,
      halfSaint: false,
      peakImmortal: true
    },
    {
      name: "Heavenly Tribulation Survival Guide",
      originQi: false,
      halfSaint: false,
      peakImmortal: true
    },
    {
      name: "Immortal Ascension Consultation",
      originQi: false,
      halfSaint: false,
      peakImmortal: true
    }
              ...
              <div className="flex gap-8">
                <span className="w-6 text-center">
                  {feature.originQi ? (
                    ...
                    <img src={cross} alt="Not included" width={20} height={20} />
                  )}
                </span>
                <span className="w-6 text-center">
                  {feature.halfSaint ? (
