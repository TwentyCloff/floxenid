...
export const SideLines = () => {
  return (
    <>
      <div className="absolute top-0 left-5 w-0.5 h-full bg-white/5"></div>
      <div className="absolute top-0 right-5 w-0.5 h-full bg-white/5"></div>
    </>
  );
};
...
export const HambugerMenu = () => {
  return (
    <div className="absolute inset-0 pointer-events-none lg:hidden">
      ...
      <div className="absolute inset-0 opacity-[.03] bg-gradient-to-b from-white/5 to-black" />
