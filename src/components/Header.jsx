...
const Header = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full z-50 h-15 transition-colors duration-300 ${
        openNavigation
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 py-2">
        ...
        <nav
          ...
          } fixed top-[56px] left-0 right-0 bottom-0 bg-black lg:static lg:flex lg:mx-auto lg:bg-transparent`}
        >
