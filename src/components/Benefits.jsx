...
const WhyChooseUs = () => {
  ...
  return (
    <section className="relative py-24 overflow-hidden">
      ...
      {/* Background with clipPath - EXACTLY as you had it */}
      ...
      {/* MAIN CONTENT - NO CHANGES TO YOUR DESIGN */}
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              {/* Added the critical clip path div structure */}
              <div 
                className="absolute inset-0.5 bg-n-7/50 rounded-xl"
              ...
              {/* Your original card content - completely unchanged */}
              <div className="h-full bg-n-7/50 backdrop-blur-sm border border-n-5/20 rounded-xl p-8 transition-all duration-300 group-hover:border-n-3/50 relative z-10">
        ...
        {/* Stats section - completely unchanged */}
        <motion.div
          initial={{ opacity: 0 }}
