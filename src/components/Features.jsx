      ...
      <div className="container lg:flex flex-col lg:flex-row gap-12 items-center">
              ...
              return (
                ...
                >
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <h6 className="body-2 font-medium">{feature.title}</h6>
                      {feature.description && (
                        <p className="body-2 mt-1 text-n-3">{feature.description}</p>
                      )}
                    </div>
                  </div>
                </div>
        ...
        <div className="relative w-full max-w-[32rem] lg:w-[40rem] aspect-square">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative w-40 h-40 rounded-xl bg-n-8 border-2 border-primary/30 flex items-center justify-center p-6">
