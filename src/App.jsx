...
const NotFound = () => (
  <div
    className="min-h-screen flex flex-col items-center justify-center text-center px-6 relative overflow-hidden pb-[10rem] space-y-4 pt-20"
    style={{
  ...
  >
    ...
    <p className="text-2xl lg:text-3xl text-white font-semibold drop-shadow-md z-10">
      Halaman Tidak Ditemukan
    </p>
    <p className="text-white/80 max-w-md z-10 leading-relaxed drop-shadow-sm">
